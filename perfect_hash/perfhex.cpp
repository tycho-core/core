...
// Created : Tuesday, 8 April 2008 9:52:24 PM
// ------------------------------------------------------------------------------
 ...
 */
static ub4 find_adder(ub4 a, ub4 b, ub4 c)
{
  return (a^b^c^3);
}
...
static void hexthree(key      *keys, gencode  *final, hashform *form)
{
  ...
  if (x != y && x != z && y != z)
  {
    if (form->perfect == hashform::NORMAL_HP || (x != 3 && y != 3 && z != 3))
    {
      /* h3a: 0,1,2 */
 ...
 */
static int testfour(ub4 a, ub4 b, ub4 c, ub4 d)
{
