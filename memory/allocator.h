...
#if defined(TYCHO_LINUX) || defined(TYCHO_ESP32)
#include <stddef.h>
#endif // TYCHO_LINUX
...
namespace core
{
    ...
    public:
        ...
        /// realloc memory block. It will resize the existing block if possible or allocate a new
        /// block, copy the old contents to it and release the existing block. \warning This is only
        /// valid if the original allocation used default alignment.
